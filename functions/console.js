function consoleNextMessage({fableId, id, currentPlotpoint, msg, hp, roll, plotpoint, damage, damageRolls }) {
  console.log('   ')
  ...
  if(damage) {
    ...
    console.log('   Damage taken: \u001b[1;31m'+damageRolls+ " (Total: "+damage+')\u001b[0m')
